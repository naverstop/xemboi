...
export const tarotKo = {
  ...
  bulk_del_confirm: "선택한 {{n}}개 타로 기록을 삭제할까요?\n삭제한 기록은 복구할 수 없어요.",
  bulk_del_fail: "일부 기록을 삭제하지 못했어요. 잠시 후 다시 시도해 주세요.",
  ...
  /* 개인정보 고지·후기 */
  privacy_what: "질문·카드 리딩 대화",
  reviews_title: "이용자 후기",
  ...
  flipguide_msg: "아래 카드를 <b>한 장씩 손으로 눌러</b> 뒤집어 주세요 · <b>{{n}}</b>장 남음",
  flipguide_celtic: "🃏 가운데 <b>겹쳐 놓인 두 장</b>은 위에 얹힌 카드부터 각각 눌러 주세요. 헷갈리면 아래 <b>한 번에 뒤집기</b>를 눌러 한꺼번에 여셔도 됩니다.",
  flip_all: "✨ 한 번에 뒤집기",
  ...
  /* 이 카드로 1:1 상담 CTA */
  consult_btn_title: "지금 뽑은 카드가 타로 상담사에게 그대로 전달됩니다",
  consult_cta_title: "이 카드로 1:1 상담",
  consult_cta_desc: "방금 뽑은 카드가 그대로 전해져요 — 타로 상담사와 이 카드로 상담합니다",

  /* 5. 해석(리딩) */
  entry_charged: "✓ 타로 입장료 {{n}} {{pt}} 차감됨",
  reading_sub: "카드가 전하는 이야기",
  reading_qecho: "질문 — {{q}}  ({{sec}} · {{spread}})",
  reading_live: "카드를 읽어 해석하고 있어요",
  reading_loading: "해석을 불러오는 중…",
  refining_tag: "✨ 보강 중…",
  reading_fail: "해석 생성에 실패했어요. 네트워크나 서버 사정일 수 있어요.",
  retry_free: "다시 시도 (무과금)",
  preview_note_member: "🔒 <b>미리보기</b>로 앞부분만 보여드렸어요. <b>새 리딩</b>으로 전체 풀이(복사·공유·PDF 포함)를 받아보세요.",
  preview_note_guest: "🔒 <b>미리보기</b>로 앞부분만 보여드렸어요. 비로그인 리딩은 전체 해석이 잠깁니다 — <b>로그인 후 새 리딩</b>으로 전체 풀이(복사·공유·PDF 포함)를 받아보세요.",
  pdf_doc: "{{name}} 님의 타로 리딩",
  pdf_item_q: "타로 추가 질문",
  pdf_person: "{{name}} 님",
  pdf_item: "타로 리딩 ({{sec}})",
  qa_live: "답변을 생성하고 있어요",
  qa_refined: "✨ 보강됨",
  qa_charged: "✓ {{n}}{{pt}} 차감됨",
...
export const tarotVi: typeof tarotKo = {
  ...
  bulk_del_confirm: "Xóa {{n}} bản ghi Tarot đã chọn?\nBản ghi đã xóa không thể khôi phục.",
  bulk_del_fail: "Không thể xóa một số bản ghi. Vui lòng thử lại sau.",
  ...
  sel_aria: "Chọn",
  bulk_del_btn: "🗑 Xóa mục đã chọn",
  bulk_deleting: "Đang xóa…",

  privacy_what: "câu hỏi·hội thoại luận giải lá bài",
  reviews_title: "Đánh giá của người dùng",
  ...
  flipguide_msg: "Hãy <b>tự tay nhấn từng lá</b> bên dưới để lật · còn <b>{{n}}</b> lá",
  flipguide_celtic: "🃏 <b>Hai lá xếp chồng</b> ở giữa: hãy nhấn lần lượt từ lá nằm trên. Nếu thấy rối, bạn có thể nhấn <b>Lật tất cả</b> bên dưới để mở cùng lúc.",
  flip_all: "✨ Lật tất cả",

  legend_aria: "Bố cục lá bài",
  legend_wait: "Chưa lật",

  consult_btn_title: "Những lá bài bạn vừa rút sẽ được chuyển nguyên vẹn cho tư vấn viên Tarot",
  consult_cta_title: "Tư vấn 1:1 với những lá bài này",
  consult_cta_desc: "Lá bài vừa rút được chuyển nguyên vẹn — bạn sẽ tư vấn với tư vấn viên Tarot bằng chính những lá này",

  entry_charged: "✓ Đã trừ phí vào cửa Tarot {{n}} {{pt}}",
  reading_sub: "Câu chuyện mà lá bài muốn kể",
  reading_qecho: "Câu hỏi — {{q}}  ({{sec}} · {{spread}})",
  reading_live: "Đang đọc và luận giải lá bài",
  ...
  preview_note_member: "🔒 Chúng tôi chỉ hiển thị phần đầu ở chế độ <b>xem trước</b>. Hãy dùng <b>lượt xem mới</b> để nhận trọn bộ luận giải (gồm sao chép·chia sẻ·PDF).",
  preview_note_guest: "🔒 Chúng tôi chỉ hiển thị phần đầu ở chế độ <b>xem trước</b>. Lượt xem khi chưa đăng nhập sẽ bị khóa toàn bộ luận giải — hãy <b>đăng nhập rồi bắt đầu lượt xem mới</b> để nhận trọn bộ luận giải (gồm sao chép·chia sẻ·PDF).",
  pdf_doc: "Bản luận Tarot của {{name}}",
  pdf_item_q: "Câu hỏi thêm Tarot",
  pdf_person: "{{name}}",
  pdf_item: "Luận giải Tarot ({{sec}})",
  qa_live: "Đang tạo câu trả lời",
